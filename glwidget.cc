...
void GLWidget::zwzdone()
{
    ...
    GLfloat *img =
            new GLfloat[(viewport[2]-viewport[0])
    ...
    fea->setMat(img,viewport[3],viewport[2]);
    qDebug()<<"setMat done"<<endl;
    fea->setProjectArea();
    qDebug()<<"setProjectArea done"<<endl;
    fea->setVisSurafaceArea(vertices,VisibleFaces);
    qDebug()<<"setVisSurfaceArea done"<<endl;
//    fea->setViewpointEntropy();
    fea->setSilhouetteLength();
    qDebug()<<"setSilhouetteLength done"<<endl;
//    fea->setSilhouetteCurvature();
//    fea->setSilhouetteCurvatureExtrema();
    fea->setMaxDepth(img,viewport[2]*viewport[3]);
    qDebug()<<"setMaxDepth done"<<endl;
//    fea->setDepthDistribute();
    fea->setMeanCurvature(m_mesh,isVertexVisible);
    qDebug()<<"setMeanCurvature done"<<endl;
    fea->setGaussianCurvature(m_mesh,isVertexVisible);
    qDebug()<<"setGaussianCurvature done"<<endl;
//    fea->setMeshSaliency();
//    fea->setAbovePreference();
//    fea->setEyes();
//    fea->setBase();
